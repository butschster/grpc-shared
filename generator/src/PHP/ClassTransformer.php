...
{
    public const COMMAND_NAMESPACE = 'Shared\\gRPC\\Services\\';
    ...
    public function cleanNamespace(?string $prefix = null): self
    {
        ...
        if (\str_starts_with($namespace, 'Shared\\gRPC\\Services\\')) {
            $namespace = \str_replace('Shared\\gRPC\\Services\\', '', $namespace);
